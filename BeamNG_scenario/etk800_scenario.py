...
for car_speed in speed:
    my_dict={'etk_transmission' : ['etk_transmission_6M_sport', 'etk_transmission_8DCT','etk_transmission_6M_diesel'],
     'tire_F_18x9':['tire_F_225_45_18_sport','tire_F_225_45_18_race','tire_F_225_45_18_standard'],
    ...
    for x in list(combinations):
        # Calling BeamngPY
        bng = BeamNGpy('localhost', 62134, home='C:/Beamng/trunk')
        ...
        vehicle1 = Vehicle('ego_vehicle', model='etk800', licence='Main01', color = 'White')
        ...
        config_trans['parts']['van_transmission'] = x[1]
        ...
        config_tire['parts']['tire_R_16x8_alt'] = x[2]
        set_config_tire = vehicle1.set_part_config(config_tire)

        if (x[2] == 'tire_F_225_45_18_sport'):
            tire_main = 'tire2'
        elif (x[2] == 'tire_F_225_45_18_race'):
            tire_main = 'tire1'
        else:
            tire_main = 'tire3'
        ...
        for index in range(100000):
            ...
            if (vehicle_distance1 <= 20 and car_speed_km == 30) or (vehicle_distance1 <= 20 and car_speed_km == 35) or (vehicle_distance1 <= 20 and car_speed_km == 40) :
                vehicle1.ai_set_mode('stopping')
                time.sleep(5)

                if (vehicle_distance1 > 19):  # 18
                    ispass = 1
                    print('pass')
                else:
                    ispass = 0
                ...
                if (ispass == 1 or ispass == 0):
                    path_dir = os.getcwd()
                    file_name_csv = (path_dir + '\dataset_etk800_new.csv')
                    ...
                    with open(file_name_csv, 'a') as f:
                        ...
                        if fileEmpty:
                            writer.writeheader()
                        writer.writerow({ 'Tire': tire_main ,'Brake' : brake_main ,'Transmission' : trans_mission, 'Car_model': 'etk800' , 'Speed': car_speed_km, 'Result' : ispass})
                break
            elif (vehicle_distance1 < 20 and car_speed_km == 45) or (vehicle_distance1 <= 20 and car_speed_km == 50) or (vehicle_distance1 <= 20 and car_speed_km == 55) :
                vehicle1.ai_set_mode('stopping')
